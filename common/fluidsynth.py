...
Remove iteritems, fix settings bugs, Eran Egozy (egozy@mit.edu)
...
# these are not implemented in fluidsynth 1.1.10
...
class Synth:
    ...
    def get_chorus_level(self):
        return fluid_synth_get_chorus_level(self.synth)
